                ...
                <table class="table table-striped table-bordered table-hover" id="tabla-data">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$item->nombre}}</td>
                            <td>
                                <a href="{{route('editar_rol',['id' => $item->id])}}" class="btn-accion-tabla tooltipsC" title="Editar este Rol">
                                    <i class="fa fa-fw fa-pencil"></i>
                                </a>
                                <form action="{{route('eliminar_rol', ['id' => $item->id])}}" class="d-inline form-eliminar" method="POST">
                                    @csrf @method("delete")
